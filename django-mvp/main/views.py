...
market_items = [market_item(img="yoda.jpg", heading="Hone your Jedi Skills",
                            ...
                            training and achievements ladders.  Show off your Star
                            Wars skills, progress through the levels and show
                            everyone who the top Jedi Master is!"""
                            ),
                market_item(img="clone_army.jpg", heading="Build your Clan",
                            caption="""Engage in meaningful conversation, or
                            bloodthirsty battle! If it's related to Star Wars
                            you better believe we do it."""
                            ),
                market_item(img="leia.jpg", heading="Find Love",
                            caption="""Everybody knows Star Wars fans are the
                            best mates for Star Wars fans.  Find your Princess
                            Leia or Han Solo and explore the stars together.""",
